      ...
      <div className="container">
        <div className="row width-card-menter " >
          <div className="main-div mt-3 p-3 col-md-8 col-sm-6">
            <div className="row">
              <div className="tw-rounded-xl tw-bg-white tw-shadow-sm tw-relative tw-overflow-hidden tw-p-5">
                <div className="part1">
                  <div className='left'>
                    {/* <img alt=" menter avatar" test_id="avatar" className="imgstyle" src="img/nv1.jpg" lazy="loaded"></img> */}
                    <img alt=" menter avatar" test_id="avatar" className="imgstyle" src="img/nv1.jpg" lazy="loaded"></img>
                  </div>
                  ...
                  <div className='mid'>
                    <div className='mentor-name'>
                      <div className="mentor-name ">
                        <a href="/mentorprofile" target="_blank" className="menter-link">
                    ...
                    <div>
                      <div className="pos"> Founder @ GrowthMentor  </div>
                    </div>
                    <div className='dd' style={{ display: "flex", flexDirection: "column" }}>
                      <div className="desc1">
                        <span className="launage">
                          <svg viewBox="0 0 12 16" fill="none" className="svgstyle">
                            <path d="M11.5 6c0 4.5-5.5 9.5-5.5 9.5S.5 10.5.5 6a5.5 5.5 0 1111 0v0z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"></path><path d="M6 8.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
                            </path></svg>
                          Athens, Greece (+02:00 UTC) </span>
                        <span className="launage">
                          <svg viewBox="0 0 16 16" fill="none" className="svgstyle">
                            ...
                            <path d="M8 15.5a7.5 7.5 0 100-15 7.5 7.5 0 000 15z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"></path>
                            <path d="M12.782 8.616c.029 2.1-2.708 4.725-4.1 4.157-1.22-.5-.36-1.458-.672-4.157C7.88 7.494 9.078 6.57 10.4 6.57a2.244 2.244 0 012.382 2.045v0z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                          Hindi, English </span><span className="" style={{ marginBottom: "0.5rem" }}> Surat, India </span>
                      </div></div>
                  </div>
                    ...
                    <div className="ratingsession">
                      <div className="star">
                        <div className="tw-shrink-0">
                          <svg viewBox="0 0 18 17" fill="none" className="svgstyle" style={{ color: "orange", marginRight: "8px", marginBottom: "8px" }}>
                          ...
                          4.99</span></div>
                      <div className="reviewsession"> 253 reviews / 458 sessions </div>
                      <div className="tw-mt-3 tw-flex tw-items-center tw-space-x-2 tw-font-semibold">
                        <span className="fees"> Free </span><svg viewBox="0 0 16 12" fill="none" className="svgstyle" style={{ color: "rgb(190 199 215 / var(1))" }}>
            ...
            <div className="row">
              ...
              <div className='col-4 end'>
                <div className="schedule">
                  {/* Calande SVG */}
                  <svg viewBox="0 0 15 15" fill="none" className="svgstyle"><path d="M13.242 1.172h-.703V0h-1.172v1.172H3.633V0H2.46v1.172h-.703A1.76 1.76 0 000 2.93v10.312C0 14.212.789 15 1.758 15h11.484A1.76 1.76 0 0015 13.242V2.93a1.76 1.76 0 00-1.758-1.758zm.586 12.07a.587.587 0 01-.586.586H1.758a.587.587 0 01-.586-.586V5.508h12.656v7.734zm0-8.906H1.172V2.93c0-.323.263-.586.586-.586h.703v1.172h1.172V2.344h7.734v1.172h1.172V2.344h.703c.323 0 .586.263.586.586v1.406z" fill="currentColor"></path><path d="M3.398 6.738H2.227V7.91h1.171V6.738zm2.344 0H4.57V7.91h1.172V6.738zm2.344 0H6.914V7.91h1.172V6.738zm2.344 0H9.258V7.91h1.172V6.738zm2.343 0h-1.171V7.91h1.171V6.738zM3.398 9.082H2.227v1.172h1.171V9.082zm2.344 0H4.57v1.172h1.172V9.082zm2.344 0H6.914v1.172h1.172V9.082zm2.344 0H9.258v1.172h1.172V9.082zm-7.032 2.344H2.227v1.172h1.171v-1.172zm2.344 0H4.57v1.172h1.172v-1.172zm2.344 0H6.914v1.172h1.172v-1.172zm2.344 0H9.258v1.172h1.172v-1.172zm2.343-2.344h-1.171v1.172h1.171V9.082z" fill="currentColor"></path></svg>
                  <span> Next available - Monday, <br /> October 10, 2022 3:30 PM IST </span></div>

                {/* Button container */}
                <div className="tw-mt-4 tw-flex tw-flex-col tw-space-y-2" style={{ marginTop: "1rem", display: "flex", flexDirection: "column" }}>
                  <div className="tw-inline-block">

                    {/* REQUEST CALL button */}
                    <a href="https://morning-escarpment-67980.onrender.com/">
                      <button className="search-bar-button edited1">Request a Call </button>
                    </a>
                    {/* end */}

                    {/* VIEW PROFILE button */}
                    <a href='/profilehistory'>
                      <button href="https://app.growthmentor.com/mentors/foti-panagio" target="_blank" className="search-bar-button edited1 edited2">View Profile </button>
                    </a>
                    {/* end */}
